...
public class AudioCaptureToWwise : MonoBehaviour
{
    // 
    ...
    private void Start()
    {
        ...
        AkAudioInputManager.PostAudioInputEvent(AudioInputEvent.PlayingId, gameObject, AudioSamplesDelegate, AudioFormatDelegate);
    }
