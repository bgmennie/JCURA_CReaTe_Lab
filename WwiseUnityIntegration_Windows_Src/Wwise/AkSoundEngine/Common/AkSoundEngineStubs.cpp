...
#if defined(__ANDROID__) || (defined(AK_LINUX) && !defined(AK_GGP)) || defined(AK_NX) || defined(AK_EMSCRIPTEN)
	...
	)
{
	...
	AK_OSPRINTF(msg, msgLen/sizeof(AkOSChar), AKTEXT("AKASSERT: %s. File: %s, line: %d"), os_pszExpression, os_pszFileName, in_lineNumber);
